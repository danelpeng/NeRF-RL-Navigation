...
from tianshou_env import make_turtlebot_env
...
from rl_algo.rianshou_network import Navbot

def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--task", type=str, default="NeRF-RL-Nav")
...
def test_ppo(args=get_args()):
    # env, train_envs, test_envs = make_turtlebot_env(
    #     args.task, args.seed, args.training_num, args.test_num, obs_norm=True
    # )
    train_envs = make_turtlebot_env(
    ...
    print("Action range:", np.min(train_envs.action_space.low), np.max(train_envs.action_space.high))
    # seed
    ...
    tianshou_example_path = os.path.dirname(__file__)
    log_path = os.path.join(tianshou_example_path, log_path)
